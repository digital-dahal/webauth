...
const signup=(e)=>{
	    e.preventDefault();
	try{
		 axios.post("http://localhost:2000/auth/signIn",{
			name:name,
			email:email,
			password:pass
		}).then((response)=>{
...
<div className="container__form__flex">
 ...
 <h3 class="uk-card-title"className="container__form__text">Mars Login</h3>
   </div>
	...
	<p onClick={goBack}>SignUp?</p>
		...
		<img className="wave" id='wave' src={wave}/>
 		<h1 id="register">Welcome again to mars</h1>
